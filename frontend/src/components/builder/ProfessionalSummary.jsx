                ...
                <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
                    ...
                    <div className='space-y-2'>
                        ...
                        <Controller
                            ...
                            render={({ field }) => (
                                <AITextField {...field} placeHolder={"Ex: Experienced software engineer with 5+ years in AI and web development. Passionate about building scalable applications and leveraging machine learning to solve real-world problems. Proven track record of leading cross-functional teams and delivering high-impact projects."}
                              />
                            )}
                        />
                        {/* Character Counter */}
                    ...
                    <div className='flex flex-col sm:flex-row justify-center gap-4 pt-4'>
                        <button
                            ...
                            className={`px-6 py-3 font-semibold rounded-lg transition flex items-center justify-center gap-2 ${isSubmitting
