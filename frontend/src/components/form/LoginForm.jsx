...
function LoginForm() {
    ...
    const onSubmit = async(data) => {
        ...
        if(response.success){
            const loginData = {user_id:response.id  ,username: response.username, email: response.email, accessToken: response.accessToken};
                ...
                <div className='w-full max-w-md bg-gray-800 border border-gray-700 rounded-2xl p-8 shadow-2xl'>
                    <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col space-y-6'>
                        ...
                        <div className='text-center mb-4'>
                            ...
                            <p className='text-gray-400 text-sm'>Welcome back to ResumeAI</p>
                        </div>
